...
I will draw up a simple visNetwork to show the linkages of `Edge Type` == "MemberOf' to respective Person and MusicalGroup nodes.
This is for the initial step for visualization and checking the affliation of each Person to a Group.
...
### Number of songs in genres with notoriety_date
...
### Number of songs in genres with notorable count
...
"Dream Pop", "Indie Folk", "Synthwave", "Doom Metal", "Oceanus Folk",
 "Alternative Rock", "Southern Gothic Rock", "Indie Rock", "Americana", "Psychedelic Rock"
...
I will select the top 6 genres based on number of songs and filter to the top 5 artists with the most notable songs.
...
I will explore and derive some findings of the 3 artists and any characteristics on how popular & influential they are as top artist in their field.
...
*Leyla Graf-Gotthard - Doom Metal*

*Szymon Pyć - Southern Gothic Rock*
...
Using notable songs as a proxy for popularity, let's compare the notable songs of the selected 3 artists in their respective genre vs overall.

This will show how many notable songs the artist produced overall and how many were actually their main genre.
...
- Based on the bar graphs, Kimberly Snyder has the most notable songs released but ties with Matthew Hancock in the Dream Pop genre. However, this shows the influence Kimberly has on other genres.
...
-   How each of the artist is able to maintain popularity would be due to the release of "notable" songs consistently throughout the years. This is a clear signal on how the artist still maintains its popularity.
:::

## Popularity: Percentage of popular songs released by artist
...
These 3 artist have a majority (More than 2/3 of the total) of notable songs as compared to non-notable songs.
This is another good signal that shows how the artist is able to maintain popularity by releasing top charting songs consistently.
:::
...
::: {.callout-note title="Work-type Influences"}
These plots show the work influences by the artist within their scope and also how their work with other people. 
:::


## Influence: People Interactions

This portion will cover how people are directly/indirectly influenced by the selected artists and their work.
I will be plotting a visNetwork and barchart for Betweenness value to show the influence.
...
- Dropdown select to see the artists and their influences.

**Betweenness CentralityValue**
- This measures a node's influence in a network by quantifying how often it lies on the shortest paths between other nodes.
- I will be solely using as information to show what are the most relevant "bridges" controlling the flow of in the network using maximum hop of 3.

### Kimberly Snyder 

::: panel-tabset

#### People Influence Edge Types
...
These plots show each artist has a difference in which external node (song/album/person) had the most influence and control. 
:::
...
Based on the above plot, the trend of how many songs released by each member is similar. Just that Kimberly Snyder has more each year. This could also show how Kimberly had more notable songs due to more effort in producing songs each year which lead to her popularity and influence.
:::



# **Part (b) Using this characterization, give three predictions of who the next Oceanus Folk stars with be over the next five years**

To predict the next Oceanus Folk stars over the next 5 years, I would need to check on the popularity + influence nodes that was done in part (a).
I will see if there is a pattern in the plots and predict from there who I think will be the next upcoming stars.
...
You can see the spread of artists with notable songs but we have yet to limit the years as we are not interested in long-careered artists but emerging artists
:::

### Songs timeline

We will now plot these songs across the years to visualize which years we should set as our limit.
...
::: {.callout-tip title="Sailor Shift"}
- It's worth to note that Sailor Shift has alot more notable songs overall. But only 1 of it fell in the 2025 - 2035 period.
...
Based on the Popularity and Influence plots. There is significant evidence that show that Orla Seabloom, Beatrice Albright & Daniel O'Connell are the next upcoming Oceanus Folk stars that debut recently that will likely continue to chart over the next 5 years.
