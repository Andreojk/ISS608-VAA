...
You can examine the content of [mpsz]{style="color:purple;"} by using the code chunk below.
...
- The default colour scheme used is [YlOrRd]{style="color:purple;"} of ColorBrewer. You will learn more about the color scheme in sub-section 4.4.
